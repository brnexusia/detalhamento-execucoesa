...
try {
  ...
  await db.query(
    `UPDATE products SET created_at='2026-08-28 03:38:15.123456+00'::timestamptz
     WHERE id=ANY($1::text[])`,
    [productIds],
  )
  ...
  assert.equal(page2.products.length, 24, 'cursor deve preservar microssegundos de produtos inseridos em massa')
