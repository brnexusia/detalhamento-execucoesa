...
console.log('legacySchema', 'updated_at removida; publisher deve reparar automaticamente')
...
console.log('[cristaluxe publish] legacy schema repaired -> 175/175 saved successfully')
