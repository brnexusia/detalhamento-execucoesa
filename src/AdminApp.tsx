...
function AdminProductMedia({ product }: { product: AdminProduct }) {
  ...
  return <img src={optimizedMediaUrl(product.media_url, 'thumb')} alt={product.name} onError={() => setFailed(true)} />
}
