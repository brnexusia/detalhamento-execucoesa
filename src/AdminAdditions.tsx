...
import { BarChart3, Boxes, CreditCard, Images, Settings, TrendingUp, UsersRound } from 'lucide-react'
...
export default function AdminAdditions() {
  ...
  return <>
    {navTarget && createPortal(<>
      ...
      <button onClick={() => go('/painel/assinatura')}><CreditCard size={18}/><span>Assinatura</span></button>
    </>, navTarget)}
